...
OUTPUT_DIR   = 'outputs/Cardiomegaly/GradCAM/V11'
SCORE_THRESH  = 0.3
...
for idx, image_path in enumerate(all_images):
    ...
    try:
        ...
        #           cv2.cvtColor(resize_keep_ratio(cv2.cvtColor(cam_only_rgb,  cv2.COLOR_RGB2BGR), OUTPUT_SIZE), cv2.COLOR_BGR2RGB),
        #           cv2.cvtColor(cam_full_bgr, cv2.COLOR_BGR2RGB),
