...
OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/CascadeRCNN_PRED_GT'
...
#OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/DynamicRCNN_PRED_GT'
...
#OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/FasterRCNN_PRED_GT'
...
#OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/FCOS_PRED_GT'
...
#OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/Retina_PRED_GT'
...
#OUTPUT_DIR   = '/home/ai/mmdetection3x/imgs/outputs/cardiomegaly/NoCAM_IOU/Sparse_PRED_GT'
...
SCORE_THRESH  = 0.3
IOU_THRESH    = 0.5
TARGET_SIZE   = 480   # resize chi?u ng?n nh?t v? gia tr? nay
...
FONT_SCALE    = 0.5
FONT_THICK    = 1
TMP_PATH      = '/tmp/mmdet_resize_tmp.jpg'  # file t?m cho inference


# -----------------------------------------------
# Helper: tinh IoU gi?a 2 box pixel
# -----------------------------------------------
...
# -----------------------------------------------
# Helper: v? IoU info goc tren ben trai
# -----------------------------------------------
...
# -----------------------------------------------
# Helper: resize gi? t? l?, chi?u ng?n = TARGET_SIZE
# -----------------------------------------------
...
def process_image(image_path, full_model, class_names, gt_dir, output_dir):
    ...
    # ¢w¢w Resize v? TARGET_SIZE px chi?u ng?n nh?t ¢w¢w¢w¢w¢w
    img_rgb = resize_keep_ratio(img_rgb, TARGET_SIZE)
    H, W    = img_rgb.shape[:2]

    # L?u ?nh ?a resize ra file t?m ?? inference_detector ??c ?ung kich th??c
    ...
    # ch? l?y 1 box co score cao nh?t
    if len(boxes_np) > 1:
