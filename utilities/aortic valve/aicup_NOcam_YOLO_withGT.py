...
# CONFIG
# -----------------------------------------------
#MODEL_PATH = 'models/v8.pt'
#MODEL_PATH = 'models/v9.pt'
#MODEL_PATH = 'models/v10.pt'
#MODEL_PATH = 'models/v11.pt'
#MODEL_PATH = 'models/v12.pt'
MODEL_PATH   = 'models/v26.pt'

INPUT_DIR    = 'images/aicup'
GT_DIR       = 'images/aicup/ground_truth'
OUTPUT_DIR   = 'outputs/AICUP/NoCAM/V26'
