...
# CONFIG
# -----------------------------------------------
#MODEL_PATH  = 'models/aicup/v8.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v8_cam.png'

#MODEL_PATH  = 'models/aicup/v9.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v9_cam.png'

#MODEL_PATH  = 'models/aicup/v10.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v10_cam.png'

#MODEL_PATH  = 'models/aicup/v11.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v11_cam.png'

#MODEL_PATH  = 'models/aicup/v12.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v12_cam.png'

#MODEL_PATH  = 'models/aicup/v26.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/v26_cam.png'

#MODEL_PATH  = 'models/aicup/rt-detr.pt'
#OUTPUT_FILE = 'imgs/outputs/aicup/No_Predict/RTDETR_cam.png'
...
# Auto-select target layer: lấy layer cuối của backbone
# YOLO backbone: model.model[i] với i là các Conv/C2f layers
# Thường layer index 9 hoặc -2 là feature map cuối backbone
try:
    # Ultralytics YOLO: backbone kết thúc trước neck (SPPF)
    target_layers = [pt_model.model[-2]]  # layer trước head
    print('Target layer: model[-2] =', type(pt_model.model[-2]).__name__)
except Exception:
    target_layers = [pt_model.model[9]]
    print('Target layer: model[9] =', type(pt_model.model[9]).__name__)
...
class YOLOWrapper(torch.nn.Module):
    ...
    def forward(self, x):
        # Chạy qua toàn bộ backbone + neck, bỏ head
        y = []
        for i, m in enumerate(self.model.model):
            ...
            x = m(x)
            y.append(x)
            # Dừng trước detection head (thường là index -1)
...
cam_rgb = show_cam_on_image(img_float_orig, heatmap, use_rgb=True)
