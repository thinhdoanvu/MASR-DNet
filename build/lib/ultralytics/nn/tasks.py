...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            c2 = ch[f[-1]]
        # For my modification -------------------------
        elif m in {MyGhost, SmallAttention, MediumAttention, LargeAttention, DynamicGhost, DynamicDCNv2, SEBlock, ECA, ASPP, ConvSE, ConvECA, MyDCNv2, MySRBlock,
                   C_Attention, H_Attention, W_Attention, Spatial_Attention, CBS, ScaleDotProduct, Contigous_Att, ConvECA, MyCBAM, CARAFE, CoordAtt, ConvCA, MyMHSA, WAFU,
                   ROIAttentionBlock, WAFU_ROIAttention, MobileNetBlock}:
            c1 = args[0]
            c2 = args[1]
        elif m in {C2f}:
            c2 = args[0]
