...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            c1 = ch[f]
            args = [*args[1:]]
        # For my modification -------------------------'''ConvHAAM, MyMHSA, SmallAttention, MediumAttention, LargeAttention, CRBM_SE, GhostHAAM, HAAMSRBlock'''
        elif m in {MyGhost, MyDCNv2, DynamicDCNv2, MySRBlock, ConvECA, ConvHAAM, MyMHSA, SmallAttention, MediumAttention, LargeAttention}:
            c1 = args[0]
            c2 = args[1]
        elif m in {C2f}:
            c2 = args[0]
